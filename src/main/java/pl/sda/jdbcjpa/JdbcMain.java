...
public class JdbcMain {
    ...
    private static void statement() {
        try (Connection connection = getConnection()){
            String query = "select ename, job, sal from sdajdbc.employee " +
                            "where sal > 100";
        ...
        // połączenia do bazy danych należy zamykać, bo może być tak że nikt inny go nie użyje, bo jest zajęty
